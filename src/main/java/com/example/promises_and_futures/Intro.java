...
public class Intro {
  ...
  public static void failOnSuccess(String str) {
    System.out.println("Failing on success");
    throw new IllegalStateException("Don't look back in anger.");
  }
  ...
  public static void main(String[] args) {
    ...
    future
      //.onSuccess(Intro::failOnSuccess) // Stop processing (just the same as in a callback)!!
